...
function InputBox() {
  ...
  return (
    <div className=' bg-white p-2 overflow-y-scroll scrollbar-hide text-gray-500 border-b border-gray-300'>
      ...
      <div className='flex gap-3 ml-20 px-3  pb-1 items-center'>
        ...
        <div className='grow text-right'>
          <button className='bg-violet-600 text-white font-bold px-6 py-1.5 rounded-full hover:bg-violet-500 disabled:bg-violet-300 disabled:cursor-default' disabled={!input && !selectedFile} onClick={sendPost}>
            Chia sẻ
          </button>
        </div>
